...
$PROGRAMS = array(
    'actor-base'    => 'Актёр: суть (8–12 лет, База)',
    'actor-pro'     => 'Актёр: суть (13–17 лет, Про)',
    'director-base' => 'Режиссёр: смыслы (8–12 лет, База)',
    'director-pro'  => 'Режиссёр: смыслы (13–17 лет, Про)',
    'podcast'       => 'Подкасты',
);
